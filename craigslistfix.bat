...
powershell -Command "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Your IP has been resynced successfully.', 'Craigslist', 'OK', 'Information')" >nul 2>&1
